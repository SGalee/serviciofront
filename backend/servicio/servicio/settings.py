...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-o76-a@03u_u6_4h%rxto-lhynfkh5ub-y4rhl=o7&^$b7m53ms')
...
INSTALLED_APPS = [
    ...
    'tesis',  # Nuestra app debe ir PRIMERO para que el modelo User se registre
    'corsheaders',  # CORS headers
    'rest_framework',
    'rest_framework.authtoken',
    'rest_framework_simplejwt',
    'rest_framework_simplejwt.token_blacklist',  # Para rotación de tokens
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'servicio_tesis_db'),
