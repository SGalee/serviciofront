...
export default function Dashboard() {
  ...
  <div className="min-h-screen min-w-screen flex">
          ...
          <div className="sm:w-1/4 lg:w-1/4 bg-orange-500 flex flex-col items-center hover:text-4xl">
            ...
            <Link to ="/dashboard" className="text-4xl px-23 py-4 rounded-4xl hover:bg-yellow-400 bg-yellow-400 transition font-semibold my-6 ">Buscar</Link>
            <Link to="/crearusuario" className="text-3xl px-19 py-4 rounded-3xl hover:bg-yellow-400 hover:text-4xl font-semibold my-6 ">Usuarios</Link>
        ...
        <div className="w-full bg-blue-500">
          <h1 className="text-6xl font-semibold">Buscar</h1>
